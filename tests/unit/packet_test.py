...
class TestPacket:
    ...
    def test_packet_uses_slots_without_instance_dict(self):
        """Packet should use slots for lower per-instance memory overhead."""
        packet = Packet(Topic.REQUEST, "target", {"x": 1})
