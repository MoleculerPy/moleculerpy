...
def test_service_allows_dynamic_attributes_with_slots():
    """Service keeps dynamic state compatibility even with __slots__."""
    s = Service("test")
    assert not hasattr(s, "__dict__")
    s.runtime_state = {"ready": True}
    assert s.runtime_state == {"ready": True}
