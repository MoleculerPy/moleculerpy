...
from moleculerpy.logger import (
    LOG_LEVEL_MAP,
    get_logger,
...
class TestMoleculerFormatRenderer:
    ...
    def test_moleculer_format_renderer_basic(self):
        ...
        with patch("moleculerpy.logger.datetime") as mock_datetime:
            mock_now = datetime.datetime(2023, 1, 1, 12, 0, 0, 123000, tzinfo=datetime.UTC)
    ...
    def test_moleculer_format_renderer_different_levels(self):
        ...
        for level in levels:
            ...
            with patch("moleculerpy.logger.datetime") as mock_datetime:
                mock_now = datetime.datetime(2023, 1, 1, 12, 0, 0, 0, tzinfo=datetime.UTC)
