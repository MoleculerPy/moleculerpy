#!/usr/bin/env python3
"""
Example client for testing MoleculerPy services.
This script demonstrates how to interact with the services started by the moleculerpy CLI.
"""
...
async def run_client():
    ...
    try:
        ...
        welcome = await broker.call("greeter.welcome", {"name": "MoleculerPy User"})
        print(welcome)
