#!/usr/bin/env python3
"""Command line interface for the MoleculerPy framework.

This module provides the CLI tool for running MoleculerPy service brokers
...
async def run_broker(
    ...
    print(f"Starting MoleculerPy broker '{broker_id}' with transporter: {transporter}")
...
def create_argument_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="MoleculerPy - Run a service broker and load services from a directory",
...
def main() -> None:
    """Entry point for the MoleculerPy CLI command."""
